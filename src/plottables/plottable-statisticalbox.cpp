...
/*! \class QCPStatisticalBoxData
  ...
  The container for storing multiple data points is \ref QCPStatisticalBoxDataContainer.
  ...
  sample data in half (50% of the sample data is below/above the median).
